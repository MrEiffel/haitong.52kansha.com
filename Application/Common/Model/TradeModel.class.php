...
class TradeModel extends \Think\Model
{
	...
	public function dapan($market = NULL)
	{
		...
		for (; $i < 30; $i++) {
			...
			if ($buy && $sell && (0 <= floatval($buy['price']) - floatval($sell['price']))) {
				...
				$finance = $mo->table('ecshecom_finance')->where(array('userid' => $sell['userid']))->order('id desc')->find();
						...
						if ($buy_fee) {
							if ($invit_buy_user['invit_1']) {
								...
								if (0 < $invit_buy_save_1) {
									$finance = $mo->table('ecshecom_finance')->where(array('userid' => $invit_buy_user['invit_1']))->order('id desc')->find();
									$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_buy_user['invit_1']))->find();
									...
									$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_buy_user['invit_1']))->find();
									$finance_hash = md5($invit_buy_user['invit_1'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_buy_user['invit_2']) {
								...
								if (0 < $invit_buy_save_2) {
									$finance = $mo->table('ecshecom_finance')->where(array('userid' => $invit_buy_user['invit_2']))->order('id desc')->find();
									$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_buy_user['invit_2']))->find();
									...
									$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_buy_user['invit_2']))->find();
									$finance_hash = md5($invit_buy_user['invit_2'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_buy_user['invit_3']) {
								...
								if (0 < $invit_buy_save_3) {
									$finance = $mo->table('ecshecom_finance')->where(array('userid' => $invit_buy_user['invit_3']))->order('id desc')->find();
									$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_buy_user['invit_3']))->find();
									...
									$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_buy_user['invit_3']))->find();
									$finance_hash = md5($invit_buy_user['invit_3'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
						...
						if ($sell_fee) {
							if ($invit_sell_user['invit_1']) {
								...
								if (0 < $invit_sell_save_1) {
									$finance = $mo->table('ecshecom_finance')->where(array('userid' => $invit_sell_user['invit_1']))->order('id desc')->find();
									$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_1']))->find();
									$rs[] = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_1']))->setInc($rmb, $invit_sell_save_1);
									$rs[] = $mo->table('ecshecom_user_coin')->getLastSql();
									...
									$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_1']))->find();
									$finance_hash = md5($invit_sell_user['invit_1'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_sell_user['invit_2']) {
								...
								if (0 < $invit_sell_save_2) {
									$finance = $mo->table('ecshecom_finance')->where(array('userid' => $invit_sell_user['invit_2']))->order('id desc')->find();
									$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_2']))->find();
									...
									$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_2']))->find();
									$finance_hash = md5($invit_sell_user['invit_2'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_sell_user['invit_3']) {
								...
								if (0 < $invit_sell_save_3) {
									$finance = $mo->table('ecshecom_finance')->where(array('userid' => $invit_sell_user['invit_3']))->order('id desc')->find();
									$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_3']))->find();
									...
									$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $invit_sell_user['invit_3']))->find();
									$finance_hash = md5($invit_sell_user['invit_3'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
	...
	public function chexiao($id = NULL)
	{
		...
		$mo = M();
		$mo->execute('set autocommit=0');
		$mo->execute('lock tables ecshecom_user_coin write  , ecshecom_trade write ,ecshecom_finance write');
		$rs = array();
		$user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();

		if ($trade['type'] == 1) {
			$mun = round(((($trade['num'] - $trade['deal']) * $trade['price']) / 100) * (100 + $fee_buy), 8);
			$user_buy = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();
			...
			$finance = $mo->table('ecshecom_finance')->where(array('userid' => $trade['userid']))->order('id desc')->find();
			$finance_num_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();
			$rs[] = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->setInc($rmb, $save_buy_rmb);
			$rs[] = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->setDec($rmb . 'd', $save_buy_rmb);
			$finance_nameid = $trade['id'];
			$save_buy_rmb = $save_buy_rmb;
			$finance_mum_user_coin = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();
			$finance_hash = md5($trade['userid'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $save_buy_rmb . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.ecshecom.com');
			$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
			...
			$rs[] = $mo->table('ecshecom_trade')->where(array('id' => $trade['id']))->setField('status', 2);
			$you_buy = $mo->table('ecshecom_trade')->where(array(
				'market' => array('like', '%' . $rmb . '%'),
				'status' => 0,
				'userid' => $trade['userid']
			...
			if (!$you_buy) {
				$you_user_buy = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();

				if (0 < $you_user_buy[$rmb . 'd']) {
					$rs[] = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->setField($rmb . 'd', 0);
				}
			}
		}
		else if ($trade['type'] == 2) {
			$mun = round($trade['num'] - $trade['deal'], 8);
			$user_sell = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();
			...
			if (0 < $save_sell_xnb) {
				$rs[] = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->setInc($xnb, $save_sell_xnb);
				$rs[] = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->setDec($xnb . 'd', $save_sell_xnb);
			}
			...
			if (!$you_sell) {
				$you_user_sell = $mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->find();

				if (0 < $you_user_sell[$xnb . 'd']) {
					$mo->table('ecshecom_user_coin')->where(array('userid' => $trade['userid']))->setField($xnb . 'd', 0);
				}
			}
		}
		else {
